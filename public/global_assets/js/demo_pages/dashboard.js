...
var Dashboard = function () {
    ...
    return {
        ...
        initCharts: function() {
            ...
            _chartSparkline('#total-orders', 'area', 30, 50, 'basis', 750, 2000, 'rgba(255,255,255,0.5)');
            ...
            // Bar charts
            _BarChart('#hours-available-bars', 24, 50, true, 'elastic', 1200, 50, 'rgba(255,255,255,0.5)');
            _BarChart('#new-cus', 24, 50, true, 'elastic', 1200, 50, 'rgba(255,255,255,0.5)');
            _BarChart('#goal-bars', 24, 50, true, 'elastic', 1200, 50, '#5C6BC0', 'goal');
            _BarChart('#members-online', 24, 50, true, 'elastic', 1200, 50, 'rgba(255,255,255,0.5)');
