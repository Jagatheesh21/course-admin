	...
	$(document).ready(function(){
        ...
        $(document).on('click','#add_section',function(){
           ...
           $('#section').append(`<div id="sec_main_${i}"><div class="form-group row">
									...
									<div class="col-lg-9">
										<input id="sec_${i}" type="text" name="sec_name[]" class="form-control required"
								...
								<div class="form-group row">
									...
									<div class="col-lg-9">
										<textarea id="sec_desc_${i}" rows="5" name="sec_desc[]" cols="5" class="form-control required"
											placeholder="Enter Section Description">{{old('sec_desc')}}</textarea>
									</div>
							    </div>
...
<div class="page-header page-header-light">
	<div class="page-header-content header-elements-md-inline">
		<div class="page-title d-flex">
			<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Create New Module
					</span></h4>
		...
		<div class="col-md-12">
			...
			<div class="card">
				...
				<div class="card-body mt-3">
					<form action="{{route('store-module')}}" method="post" class="form-validate-jquery" enctype="multipart/form-data">
						@csrf
						<fieldset>
							...
							<div class="collapse show" id="demo1" style="">
								...
								<div class="form-group row">
									...
									<div class="col-lg-9">
										<input type="text" name="name" class="form-control required"
											value="{{old('name')}}" placeholder="Your Module Name">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-9">
										<textarea rows="5" name="desc" cols="5" class="form-control required"
											placeholder="Enter Module Description">{{old('desc')}}</textarea>
									</div>
							    </div>
							    <div class="form-group row">
									<label class="col-lg-3 col-form-label">Module Level:</label>
									<div class="col-lg-9">
										<select class="form-control required" id="level" name="category">
                            ...
                            <div id="section">
							    <div class="form-group row">
									<label class="col-lg-3 col-form-label">Section Name:</label>
									<div class="col-lg-9">
										<input type="text" id="sec_1" name="sec_name[]" class="form-control required"
											value="{{old('sec_name')}}" placeholder="Your Section Name">
									</div>
								</div>
                       ...
                       <div>
						...
						<div class="text-right">
							<button type="submit" class="btn btn-primary legitRipple">Create Module<i class="icon-paperplane ml-2"></i></button>
						</div>
					</form>
										...
										<div class="card">
											<ul class="nav nav-sidebar" data-nav-type="collapsible">
												<li class="nav-item-header">
													<div class="text-uppercase font-size-sm line-height-sm">Available Modules</div>
												</li>
											...
											<?php } else {?>
												<li class="nav-item">
													<a href="#" class="nav-link"><i class="icon-cube3"></i>No Modules Found</a>
												</li>
